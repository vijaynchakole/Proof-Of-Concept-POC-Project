...
# "C:\\Users\\hp\\Desktop\\practicals_ml\\OpenCV\\test_images\\vijay_face_image.jpg"

# img_glasses = cv2.imread("vijay_image.png", -1)
...
# test_face = cv2.imread("C:\\Users\\hp\\Desktop\\practicals_ml\\OpenCV\\test_images\\vijay_face_image.jpg")

# Create VideoCapture object to get images from the webcam:
# video_capture = cv2.VideoCapture("http://192.168.1.6:8080/video")
